        ...
        <div className="border-2 border-blue-600 rounded-lg w-full shadow-2xl bg-base-100 px-4 py-6">
          <form onSubmit={handleDonation} className="">
            <div>
              <label className="label">
                <span className="text-xl font-medium">
                  Benifited People Name
                </span>
              </label>
              <input
                type="text"
                name="name"
                placeholder="Add Benifited People Name"
                className="input rounded-md w-full border-blue-600"
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                name="items"
                className="textarea textarea-bordered h-24 rounded-md w-full border-blue-600"
                placeholder="List of Item"
                required
              ></textarea>
            </div>
            {/* Given Item image */}
              ...
              <div className="relative">
                <div className="flex justify-between items-center px-4 border-2 border-blue-400 rounded-md hover:text-blue-500">
                  <input
                    ...
                    className="relative w-full z-10 h-10 opacity-0"
                  />
                  <FaImage className="text-xl" />
                </div>
                <p className="absolute top-2 left-5 opacity-50">
                  {imageUrl ? imageUrl : "Upload Given Item's Photo"}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="input rounded-md w-full border-blue-600 focus:outline-none focus:ring"
                required
              />
            </div>
            <div className="form-control mt-6">
              <input
                className="btn btn-outline border-blue-600 hover:bg-green-800 capitalize text-xl font-semibold"
                type="submit"
                value="Donate"
              />
            </div>
